...
static edge_t *ffe(node_t * tail, elist tailEdges, node_t * head, elist headEdges)
{
	int i;
	edge_t *e;
...
edge_t *find_fast_edge(node_t * tail, node_t * head)
{
	return ffe(tail, ND_out(tail), head, ND_in(head));
}
 ...
 */
edge_t *new_virtual_edge(node_t * t, node_t * h, edge_t * orig)
{
	edge_t *e;
...
edge_t *virtual_edge(node_t * t, node_t * h, edge_t * orig)
{
	return fast_edge(new_virtual_edge(t, h, orig));
}
