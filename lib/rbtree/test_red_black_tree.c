...
int main() {
  ...
  while(option!=8) {
      ...
      case 2:
	{
	  ...
	  scanf("%i",&newKey);
	  if ( ( newNode=RBExactQuery(tree,&newKey ) )!=0 ) RBDelete(tree,newNode);/*assignment*/
      ...
      case 3:
	{
	  ...
	  scanf("%i",&newKey);
	  if ( ( newNode = RBExactQuery(tree,&newKey) ) != 0) {/*assignment*/
      ...
      case 5:
	{
	  ...
	  scanf("%i",&newKey);
	  if ( (newNode = RBExactQuery(tree,&newKey) ) != 0) {
      ...
      case 6:
	{
	  ...
	  while ( (newNode = StackPop(enumResult)) != 0) {
