...
extern GVC_t *gvNEWcontext(const lt_symlist_t *builtins, int demand_loading, void* gvw);
...
extern GVC_t *gvContextPlugins(const lt_symlist_t *builtins, int demand_loading, void* gvw);
...
extern graph_t* gvInitGraph(GVC_t *gvc, graph_t *g, char *fn, int gidx);
...
extern int gvlayout_select(GVC_t * gvc, const char *layout);
